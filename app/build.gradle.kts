...
android {
    namespace = "com.afterlight.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.afterlight.app"
        minSdk = 28
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    // Minimal Core Modules (Stage 10C: Core Strip-Down)
    implementation(project(":core-security"))
    implementation(project(":core-network"))
    implementation(project(":data-local"))
    implementation(project(":data-remote"))
    
    // Feature Modules (Stage 11: Controlled Reintroduction)
    ...
    // SQLCipher (required for loading native library)
